...
@Component({
    selector: 'app-queueScreen1',
    templateUrl: './queueScreen1.component.html',
    styleUrls: ['./queueScreen1.component.scss']
})
export class QueueScreen1Component implements OnInit {
    private time :any
    private myQueue :any
